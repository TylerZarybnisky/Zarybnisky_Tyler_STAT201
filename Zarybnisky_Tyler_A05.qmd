...
print(!(var_even && var_num) && (var_even || var_num))
...
var_seconds <- 130
string_print <- paste(var_seconds)

if(var_seconds == 1){
  string_print <- paste(string_print, "second")
} else{
  string_print <- paste(string_print, "seconds")
}

if(var_seconds %/% 60 == 1){
  string_print <- paste(string_print, "is 1 minute and")
} else {
  string_print <- paste(string_print, "is", var_seconds %/% 60, "minutes and")
}
  
if(var_seconds %% 60 == 1){
  string_print <- paste(string_print, "1 second.")
} else {
  string_print <- paste(string_print, var_seconds %% 60, "seconds.")
}
...
if (var_num > 2){
  for (i in 2:(var_num-1)){
    if (var_num %% i == 0){
      is_or_isnt <- "is not"
    }
  }
  if (is_or_isnt != "is not"){
    is_or_isnt <- "is"
  }
}
if(var_num == 1){
...
print(paste(var_num, is_or_isnt, "a prime number."))
...
print(paste0(break_point, " squared is ", break_point*break_point, ", and is the first number whose square exceeeds ", var_num, "."))
